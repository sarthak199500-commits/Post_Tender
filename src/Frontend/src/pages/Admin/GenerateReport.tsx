...
export const GenerateReport = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-card shadow-sm border border-slate-200 p-8 max-w-2xl flex gap-8">
        <div className="flex-1 space-y-6">
          <form id="reportForm" onSubmit={handleGenerate} className="space-y-6">
            <div>
              ...
              <select aria-label="Select an option" 
                ...
                className="w-full border border-slate-200 rounded-card p-3 focus:ring-2 focus:ring-brand-500 outline-none bg-slate-50 font-medium"
              >
          ...
          <div className="pt-4 flex gap-3 border-t border-slate-100">
            <button 
              ...
              form="reportForm"
              disabled={loading}
              className="bg-brand-600 hover:bg-brand-700 text-white px-6 py-2.5 rounded-card font-bold flex items-center gap-2 shadow-lg shadow-brand-100 transition-colors disabled:"
            >
        ...
        <div className="w-64 bg-slate-50 rounded-card p-6 border border-slate-100 h-fit hidden sm:block">
          <Filter className="w-6 h-6 text-brand-400 mb-3" />
