...
export const Settings = () => {
  ...
  const inputCls = 'w-full p-3 border border-slate-200 rounded-card focus:ring-2 focus:ring-brand-500 focus:outline-none bg-slate-50 focus:bg-white text-slate-800 transition-colors text-sm';
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8">
      ...
      {/* Toast Notification */}
      {toastMessage && (
        <div className="fixed top-6 right-6 z-50 bg-slate-900 text-white px-6 py-4 rounded-control shadow-2xl flex items-center gap-3 border border-slate-800 transition-all duration-300 animate-slide-in">
          <div className="bg-emerald-500/20 text-emerald-400 p-1.5 rounded-control">
      ...
      <div className="flex justify-between items-start">
        <div>
          <h1 className="text-3xl font-black text-slate-800 tracking-tight flex items-center gap-3">
            <SettingsIcon className="w-8 h-8 text-brand-600 animate-spin-slow" />
        ...
        <button
          ...
          className="flex items-center gap-2 border border-slate-200 bg-white hover:bg-slate-50 text-slate-600 hover:text-slate-800 font-bold px-4 py-2.5 rounded-card text-sm shadow-sm transition-all active:scale-95"
        >
      ...
      {/* Settings Card */}
      <div className="bg-white rounded-card shadow-xl border border-slate-200 overflow-hidden flex flex-col md:flex-row">
          ...
          <form onSubmit={handleSave} className="space-y-8">
            ...
            {activeTab === 'notifications' && (
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  <label className="flex items-center justify-between p-4 bg-slate-50 hover:bg-slate-100/70 border border-slate-150 rounded-control cursor-pointer transition-colors">
                    <div>
            ...
            {activeTab === 'diagnostics' && (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-4 border border-slate-200 rounded-control space-y-1">
                  ...
                  <div className="p-4 border border-slate-200 rounded-control space-y-1">
                    ...
                    <span className="font-mono text-sm text-slate-800 font-semibold">SQL Server (database-per-service)</span>
                  </div>
                  <div className="p-4 border border-slate-200 rounded-control space-y-1">
                ...
                <div className="bg-slate-50 border rounded-control p-5 space-y-2 mt-6">
            ...
            {activeTab !== 'diagnostics' && (
              <div className="flex justify-end gap-3 pt-6 border-t border-slate-100">
                <button
                  type="submit"
                  className="flex items-center gap-2 bg-brand-600 hover:bg-brand-700 text-white font-bold px-6 py-3.5 rounded-card text-sm shadow-lg shadow-brand-100 transition-all hover:shadow-brand-200 active:scale-95"
                >
