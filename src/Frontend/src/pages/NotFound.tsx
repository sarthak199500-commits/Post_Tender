...
export const NotFound = () => {
  ...
  return (
    <div className="p-12 flex flex-col items-center justify-center text-center min-h-[60vh]">
      ...
      <Link
        to={home}
        className="bg-blue-700 hover:bg-blue-800 text-white px-6 py-3 rounded-xl font-bold transition-colors"
      >
        Back to dashboard
      </Link>
    </div>
